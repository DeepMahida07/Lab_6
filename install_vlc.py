...
def save_installer(installer_data):
    ...
    if resp_msg.status_code == requests.codes.ok:
        ...
        with open(r"D:\Semester 2\Scripting Applications\Lab_6\vlc-3.0.17.4-win64.exe", "wb") as file:
...
def run_installer(installer_path):
    ...
    installer_path = r'D:\Semester 2\Scripting Applications\Lab_6\vlc-3.0.17.4-win64.exe'
